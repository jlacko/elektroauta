...
ggplot(reg_src, aes(x = vysoky_prijem/100, y = pct_friendly)) +
  geom_point(aes(shape = je_praha, color = je_praha),
             size = 2) +
  geom_smooth(method = "lm") +
...
ggplot(reg_src, aes(x = detached_house/100, y = pct_friendly)) +
  geom_point(aes(shape = je_praha, color = je_praha),
             size = 2) +
  geom_smooth(method = "lm") +
